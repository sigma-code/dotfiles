...
map("n", "<leader>ghr", "<cmd>lua require 'gitsigns'.reset_hunk()<cr>", opts)
map("n", "<leader>gr", "<cmd>lua require 'gitsigns'.reset_buffer()<cr>", opts)
map("n", "<leader>ghs", "<cmd>lua require 'gitsigns'.stage_hunk()<cr>", opts)
map("n", "<leader>ghu", "<cmd>lua require 'gitsigns'.undo_stage_hunk()<cr>", opts)
